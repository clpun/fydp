...
class TestCaseTableTester(unittest.TestCase):
    ...
    def test_test_case_table(self):
        ...
        channels = self.test_case_table.table.table.keys()
        F3_frequencies = [1, 2, 3, 4, 5, 7, 10, 13, 14, 15, 15, 25, 26, 27, 28, 29, 30, 33, 40, 41, 42, 43, 44, 45, 48, 53, 58, 62, 63]
        AF3_frequencies = [10, 11, 11, 12, 25, 53, 58]
        ...
        self.assertEqual(self.test_case_table.table['F3'].keys(), F3_frequencies)
        self.assertEqual(self.test_case_table.table['AF3'].keys(), AF3_frequencies)
        self.assertEqual(self.test_case_table.table['F3'][1], F3_c1_1_powers)
        self.assertEqual(self.test_case_table.table['AF3'][11], AF3_c2_11_powers)
        # TODO: check the means - the table should actually calculate the means for each array and replace the array with the mean value
        # TODO: see line 36 in test_case_table.py
